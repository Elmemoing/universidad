        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            while ($docente = mysqli_fetch_assoc($resultado)) {
              ...
              echo "<td>";
              echo "<td>";
              echo "<a href='editar_docente.php?cedula=" . $docente['id_docente'] . "' class='btn btn-outline-primary mx-1 my-1'> <i class=for='btnradio1'>Editar</i> </a>";
              echo "<a href='eliminar_docente.php?cedula=" . $docente['id_docente'] . "' class='btn btn-outline-primary mx-1 my-1'> <i class=for='btnradio1'>Borrar</i> </a>";
              echo "</td>";
              echo "</tr>";
            }
            ?>
